...
frame_weight = torch.tensor([2, 1.5, 1, 1, 1])
...
for k in use_node:
    ...
    Disc_x = model_GAN.Discriminator(input_n=output_n)
    Disc_y = model_GAN.Discriminator(input_n=output_n)
    Disc_z = model_GAN.Discriminator(input_n=output_n)
